...
Процедура ОписаниеКоманды(Команда) Экспорт
	...
	Команда.Опция("sp port", ПортСервера, "порт сервера SFTP")
	       .ТЧисло()
...
Процедура ВыполнитьКоманду(Знач Команда) Экспорт
	...
	Если ЗначениеЗаполнено(ЦелевойПуть) Тогда
		...
		РаботаСФайлами.СоздатьПапкуНаSFTP(Соединение, ЦелевойПуть);
	Иначе
		ЦелевойПуть = "";
	КонецЕсли;
	...
	Для Каждого ОтправляемыйФайл Из МассивОтправляемыхФайлов Цикл
		РаботаСФайлами.ОтправитьФайлНаSFTP(Соединение, ОтправляемыйФайл, ЦелевойПуть, Перезаписывать);
