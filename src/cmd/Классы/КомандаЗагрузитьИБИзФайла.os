...
Процедура ОписаниеКоманды(Команда) Экспорт
	...
	Команда.Опция("jc jb-count", 0, "количество заданий загрузки файла (для клиент-серверной базы)")
	       .ТЧисло()
	       .ВОкружении("CPDB_IB_JB_COUNT");
...
Процедура ВыполнитьКоманду(Знач Команда) Экспорт
	...
	КоличествоЗаданий           = ЧтениеОпций.ЗначениеОпции("jb-count");
