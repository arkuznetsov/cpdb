...
Процедура ВыполнитьКоманду(Знач Команда) Экспорт
	...
	ПутьКСкачанномуФайлу = Клиент.ПолучитьФайлСSFTP(ПутьНаДиске, ЦелевойПуть, УдалитьИсточник);
	...
	Если ЭтоСписокФайлов Тогда
		...
		Для Каждого ПолучаемыйФайл Из МассивПолучаемыхФайлов Цикл
			Клиент.ПолучитьФайлСSFTP(ОбъединитьПути(КаталогНаДиске, ПолучаемыйФайл),
