...
Процедура ВыполнитьКоманду(Знач Команда) Экспорт
	...
	ПутьКСкачанномуФайлу = Клиент.ПолучитьФайлИзNextCloud(ПутьНаДиске, ЦелевойПуть, УдалитьИсточник);
	...
	Если ЭтоСписокФайлов Тогда
		...
		Для Каждого ПолучаемыйФайл Из МассивПолучаемыхФайлов Цикл
			Клиент.ПолучитьФайлИзNextCloud(ОбъединитьПути(КаталогНаДиске, ПолучаемыйФайл),
