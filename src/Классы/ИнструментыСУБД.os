...
Функция ПолучитьВерсиюСУБД() Экспорт
	...
	СоответствиеВерсий.Вставить("2000", 8);
	СоответствиеВерсий.Вставить("9", 9);
	СоответствиеВерсий.Вставить("10", 10);
	СоответствиеВерсий.Вставить("11", 11);
	СоответствиеВерсий.Вставить("12", 12);
	СоответствиеВерсий.Вставить("13", 13);
