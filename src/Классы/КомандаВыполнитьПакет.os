...
Процедура ЗарегистрироватьКоманду(Знач ИмяКоманды, Знач Парсер) Экспорт
	...
	ОписаниеКоманды = Парсер.ОписаниеКоманды(ИмяКоманды,
						"Последовательно выполняет команды по сценариям, заданным в файлах (json)");
...
Процедура ВыполнитьШагСценария(Шаг, Знач ОбщиеПараметры)
	...
	ПараметрыПоУмолчанию = ПараметрыКомандыПоУмолчанию(Шаг["command"]);
...
Функция ПараметрыКомандыПоУмолчанию(Знач Команда)

	Парсер = Новый ПарсерАргументовКоманднойСтроки();
	
	РеализацияКоманды = МенеджерКомандПриложения.ПолучитьКоманду(Команда);
	РеализацияКоманды.ЗарегистрироватьКоманду(Команда, Парсер);

	МассивПараметров = Новый Массив();
	МассивПараметров.Добавить(Команда);
	
	ОписаниеКоманды = Парсер.РазобратьКоманду(МассивПараметров);
	
	Возврат ОписаниеКоманды.ЗначенияПараметров;

КонецФункции // ПараметрыКомандыПоУмолчанию()
