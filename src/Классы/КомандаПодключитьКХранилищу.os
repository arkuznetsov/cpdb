...
Процедура ЗарегистрироватьКоманду(Знач ИмяКоманды, Знач Парсер) Экспорт
	...
	ОписаниеКоманды = Парсер.ОписаниеКоманды(ИмяКоманды, "Подключает конфигурацию или расширение информационной базы к хранилищу конфигураций");
	...
	Парсер.ДобавитьИменованныйПараметрКоманды(ОписаниеКоманды, 
		"-extension",
		"Имя расширения, подключаемого хранилищу");
...
Процедура ПодключитьКХранилищу(Знач СтрокаПодключения
	...
	МенеджерХранилища = Новый МенеджерХранилищаКонфигурации(АдресХранилища, Конфигуратор);
	
	Если ЗначениеЗаполнено(Хранилище_ИмяПользователя) Тогда
		МенеджерХранилища.УстановитьПараметрыАвторизации(Хранилище_ИмяПользователя, Хранилище_ПарольПользователя);
	КонецЕсли;
