...
Процедура ЗарегистрироватьКоманду(Знач ИмяКоманды, Знач Парсер) Экспорт
	...
	Парсер.ДобавитьПараметрФлагКоманды(ОписаниеКоманды, 
		"-shrink-log",
		"Сжать файл лога после восстановления");
...
Функция ПолучитьПараметрыКоманды(Знач ПараметрыКоманды)
	...
	Параметры.Вставить("СжатьФайлЛог"			, ПараметрыКоманды["-shrink-log"]);
...
Функция ВыполнитьКоманду(Знач ПараметрыКоманды) Экспорт
	...
	Если Параметры.СжатьФайлЛог Тогда
		КомандаКомпрессии.СжатьФайлЛог(Параметры.База);
	КонецЕсли;
