...
//
Функция СоздатьБазу(База, МодельВосстановления = "FULL", Знач ПутьККаталогу = "", ОписаниеРезультата = "") Экспорт
...
//
Функция ПолучитьЛогическоеИмяФайлаВРезервнойКопии(Знач ПутьКРезервнойКопии, Знач ТипФайла = "D") Экспорт
