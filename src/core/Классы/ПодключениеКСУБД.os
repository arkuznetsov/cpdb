...
Функция СжатьФайлЛог(База, ОписаниеРезультата = "") Экспорт
	...
	ТекстЗапроса = """USE [" + База + "]; "
				 + "DBCC SHRINKFILE(N'" + База + "_log', 0, TRUNCATEONLY); """;
...
//    Булево    - Истина    - команда выполнена успешно
//
Функция ВыполнитьСкрипты(СкриптыВыполнения, СтрокаПеременных, ОписаниеРезультата = "") Экспорт
	
	МассивСкриптов = СтрРазделить(СкриптыВыполнения, ";", Ложь);
	МассивПеременных = СтрРазделить(СтрокаПеременных, ";", Ложь);
	
	КодВозврата = ВыполнитьСкриптыЗапросСУБД(МассивСкриптов, МассивПеременных, ОписаниеРезультата);
...
//
// Параметры:
//    МассивСкриптов       - Массив - массив с путями к файлам скриптов
//    МассивПеременных     - Массив - массив с переменными и их значениями для файлов скриптов
//    ОписаниеРезультата   - Строка - результат выполнения команды
//
// Возвращаемое значение:
//    Булево       - Истина - команда выполнена успешно
//
Функция ВыполнитьСкриптыЗапросСУБД(МассивСкриптов, МассивПеременных, ОписаниеРезультата = "") Экспорт
