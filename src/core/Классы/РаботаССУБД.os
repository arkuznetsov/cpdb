...
Функция БазаСуществует(База) Экспорт
	...
	Возврат ПодключениеКСУБД.БазаСуществует(База);
...
//
Процедура СоздатьБазуДанных(База, МодельВосстановления = "SIMPLE") Экспорт
	...
	Попытка
		Результат = ПодключениеКСУБД.СоздатьБазу(База, МодельВосстановления, ОписаниеРезультата);
