...
Функция ПолучитьВерсиюСУБД() Экспорт
	...
	// 2000 - 2000 (8)), 2005 - 9, 2008 - 10, 2012 - 11, 2014 - 12, 2016 - 13, 2017 - 14, 2019 - 15, 2022 - 16
	МассивВерсий = СтрРазделить("2000-8,9,10,11,12,13,14,15,16", ",");
	...
	Для Каждого ТекВерсия Из МассивВерсий Цикл
		...
		КонецЕсли;
	КонецЦикла;
	СоответствиеВерсий.Вставить("версия неопределена", 9999);
