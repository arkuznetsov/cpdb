...
//   Булево    - Истина - команда выполнена успешно
//
Функция УдалитьБазу(База, РезультатЗапроса = "") Экспорт
...
//   Булево    - Истина - команда выполнена успешно
//
Функция УстановитьМодельВосстановления(База, МодельВосстановления = Неопределено, РезультатЗапроса = "") Экспорт
...
//   Булево    - Истина - команда выполнена успешно
//
Функция УстановитьВладельцаБазы(База, НовыйВладелец, РезультатЗапроса = "") Экспорт
...
//   Булево    - Истина - команда выполнена успешно
//
Функция СжатьБазу(База, РезультатЗапроса = "") Экспорт
...
//   Булево    - Истина - команда выполнена успешно
//
Функция СжатьФайлЖурналаТранзакций(База, РезультатЗапроса = "") Экспорт
...
//   Булево    - Истина - команда выполнена успешно
//
Функция СоздатьРезервнуюКопию(База, Знач ПутьКРезервнойКопии, РезультатЗапроса = "") Экспорт
...
Функция ВосстановитьИзРезервнойКопии(База,
	...
	Если НЕ БазаСуществует(База, ВариантыСообщенияОСуществованииБД().СообщатьОбОтсутствии) Тогда
		Если НЕ СоздаватьБазу Тогда
			Возврат Ложь;
		Иначе
			Если НЕ СоздатьБазу(База, МоделиВосстановленияБД().Простая, РезультатЗапроса) Тогда
				Возврат Ложь;
			КонецЕсли;
		КонецЕсли;
	КонецЕсли;
...
//   Булево    - Истина - команда выполнена успешно
//
Функция ИзменитьЛогическоеИмяФайлаВБазе(База, Имя, НовоеИмя, РезультатЗапроса = "") Экспорт
